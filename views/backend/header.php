      ...
      <aside class="main-sidebar sidebar-dark-primary elevation-4">
         ...
         <div class="sidebar">
            <div class="user-panel mt-3 pb-3 mb-3 d-flex">
               <div class="image">
                  <img src="../public/images/user/<?= ($_SESSTION['image']) ?? 'image.png'; ?>" class="img-circle elevation-2" alt="<?= ($_SESSTION['image']) ?? 'image.png'; ?>">
               </div>
               <div class="info">
                  <a href="#" class="d-block"><?= ($_SESSTION['name'])??"name"; ?></a>
               </div>
            </div>
            <nav class="mt-2">
